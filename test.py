...
# clemency???
bs.write_safe(36, 9, 0b110010010)

out = ''
for i in xrange(0, len(bs), 3):
    out += str(int(''.join(random.choice('01') if c is None else c for c in bs[i:i+3]), 2))
    if i % 18 == 15: out += ' '
print >> sys.stderr, out

print >> sys.stderr, BitString.repr(bs[:81])
